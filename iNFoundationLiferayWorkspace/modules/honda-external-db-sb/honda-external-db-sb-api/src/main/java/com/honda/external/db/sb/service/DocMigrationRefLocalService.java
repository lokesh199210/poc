...
/**
 * Provides the local service interface for DocMigrationRef. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DocMigrationRefLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DocMigrationRefLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.honda.external.db.sb.service.impl.DocMigrationRefLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the doc migration ref local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DocMigrationRefLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DocMigrationRef addDocMigrationRef(DocMigrationRef docMigrationRef);
	...
	public DocMigrationRef createDocMigrationRef(long mig_ref_id);
	...
	public DocMigrationRef deleteDocMigrationRef(
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public DocMigrationRef deleteDocMigrationRef(long mig_ref_id)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DocMigrationRef fetchDocMigrationRef(long mig_ref_id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DocMigrationRef getByAppCodeDivisionNDepart(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DocMigrationRef getDocMigrationRef(long mig_ref_id)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DocMigrationRef> getDocMigrationRefs(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DocMigrationRef updateDocMigrationRef(
		DocMigrationRef docMigrationRef);
