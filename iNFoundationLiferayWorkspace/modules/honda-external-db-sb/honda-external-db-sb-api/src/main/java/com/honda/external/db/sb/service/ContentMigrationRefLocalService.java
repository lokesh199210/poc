...
/**
 * Provides the local service interface for ContentMigrationRef. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ContentMigrationRefLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ContentMigrationRefLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.honda.external.db.sb.service.impl.ContentMigrationRefLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the content migration ref local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ContentMigrationRefLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ContentMigrationRef addContentMigrationRef(
	...
	public ContentMigrationRef createContentMigrationRef(long mig_ref_id);
	...
	public ContentMigrationRef deleteContentMigrationRef(
		ContentMigrationRef contentMigrationRef);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ContentMigrationRef deleteContentMigrationRef(long mig_ref_id)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ContentMigrationRef fetchContentMigrationRef(long mig_ref_id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ContentMigrationRef getByAppCode(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ContentMigrationRef getByAppCodeDivisionNDepart(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ContentMigrationRef getContentMigrationRef(long mig_ref_id)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ContentMigrationRef> getContentMigrationRefs(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ContentMigrationRef updateContentMigrationRef(
		ContentMigrationRef contentMigrationRef);
