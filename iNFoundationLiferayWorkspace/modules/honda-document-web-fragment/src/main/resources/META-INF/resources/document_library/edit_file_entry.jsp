...
String modelOpt = "<option value=''>-Please Select-</option>";
modelOpt = modelOpt + "<option value='LXI'>LXI</option>";
modelOpt = modelOpt + "<option value='FRAGMENT'>FRAGMENT</option>";
...
AUI().ready(function(A) {
	setTimeout(function() {
    	A.all('select').each(function(object) {
    		alert(object.get("id"));
			 if(object.get("id").indexOf("<portlet:namespace />model") == 0){
				object.html("<%=modelOpt %>");
			}
