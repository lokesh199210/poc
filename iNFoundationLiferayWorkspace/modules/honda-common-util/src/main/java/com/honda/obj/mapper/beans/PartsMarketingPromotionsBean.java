...
public class PartsMarketingPromotionsBean extends INDocumentBean{
...
*
*/
public PartsMarketingPromotionsBean () {
}
...
* @param startDate
*/
public PartsMarketingPromotionsBean(String dealerLevel, String issueDate, String startDate, String endDate) {
super();
